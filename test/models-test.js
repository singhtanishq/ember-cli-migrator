...
const migrates = helper.migrates;
const it = helper.it;
...
describe('migrating models', function() {
  ...
  describe('Works with unknown types on root app directory', function() {
  ...
  describe('Works with services', function() {
  ...
  describe('Works with adapters', function() {
    ...
    it('does not copy the store', function() {
      const file = path.join(this.migrator.outputDirectory, 'my-app', 'store.js');
